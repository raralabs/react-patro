...
export const validationFunctions = {
  ...
  validatePositiveNumber: function (numberParameters) {
    ...
    Object.keys(numberParameters).forEach((key) => {
...
export const calendarFunctions = Object.seal({
  ...
  getBsMonthInfoByBsDate: function (bsYear, bsMonth, bsDate) {
    ...
    var prevbsmonthdays = calendarFunctions.getBsMonthDays(
      prevbsyear,
      prevbsmonth
    );
    ...
    return {
      ...
      adStartingDayOfWeek:
        adInitialDateForMonth.day() === 0 ? 7 : adInitialDateForMonth.day(),
      adPrevMonth: moment_date.month() - 1 !== -1 ? moment_date.month() : 12,
      adPrevYear:
        moment_date.month() === 11
          ? moment_date.year() - 1
          : moment_date.year(),
