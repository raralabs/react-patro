...
//     console.log(
//       "AD DATE FOR",
//       calendarFunctions.getAdDateObjectByBsDate(2077, 4, 22)
//     );
...
//         >
//           {day_diff == 0
//             ? this.props.zeroDayName || "Today"
//             : `Within ${day_diff} Days`}
//         </div>
//       );
//     });
//     return _options;
...
//     let _dayValue = is_AD
//       ? calendarRenderingData.adDayValue
//       : calendarRenderingData.bsDayValue;
...
//                             if (
//                               selected_data.day &&
//                               ad_date.day === selected_data.day &&
//                               ad_date.year === selected_data.year &&
//                               ad_date.month === selected_data.month &&
//                               isCurrentMonth
//                             ) {
//                               isSelected = true;
//                             }
...
//                             if (
//                               todayDateAD.day == ad_date.day &&
//                               todayDateAD.month == ad_date.month &&
//                               todayDateAD.year == ad_date.year
//                             ) {
//                               isToday = true;
//                             }
...
//             {this._referenceRenderer(
//               this.props.reference_date,
//               this.props.rangeReference
//             )}
//           </div>
//         )}
//       </div>
