...
class NepaliRangeInputPicker extends Component {
  ...
  onDateSelect = (ad_date, shouldReset = true) => {
    ...
    } else if (this.state.selected_date_1) {
                ...
                if (e.key === "Enter" || e.key === "Tab") {
                  ...
                  let _month =
                    temp_value[1] && temp_value[1] > 0 && temp_value[1] <= 12
                      ? temp_value[1]
                      : calendarType === "AD"
                      ? this.ad_extras.month
                      : this.bs_extras.month;
                  let _year =
                    temp_value[2] &&
                    temp_value[2] >
                      calendarData.minBsYear -
                        (calendarType === "AD" ? 57 : 0) &&
                    temp_value[2] <=
                  ...
                  if (calendarType === "AD") {
                    ...
                    this.onDateSelect(
                      adDateStringToObject(_new_selected_date),
                      selected_date_2 ? false : true
                    );
                  } else {
                  ...
                  content={
                    <div className="rl-range-calendar">
                      ...
                      <NepaliCalendarForRange
                        selected_date_1={this.state.selected_date_1}
                        initialDate={
                          this.state.selected_date_2 == null
                            ? moment(
                                this.state.selected_date_1,
                                "DD-MM-YYYY"
                              ).isValid()
                              ? moment(this.state.selected_date_1, "DD-MM-YYYY")
                                  .add("month", 1)
                                  .format("DD-MM-YYYY")
